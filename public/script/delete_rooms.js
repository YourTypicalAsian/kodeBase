document.addEventListener('DOMContentLoaded', () => {
    let deltecategoiresbtn = document.querySelectorAll('.delrooms');
    deltecategoiresbtn.forEach(button => {
        ...
        button.addEventListener('click', () => {
            ...
            // fetch er  en fuction
            fetch(`/admin/rooms/${button.dataset.id}`, option) // fetch er at kalde på en adresse med en række options
